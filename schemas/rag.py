...
class RetrievedContextChunk(BaseModel):
    ...
    chunk_id: str
    source_title: str = Field(..., description="E.g., FDA Label, NHS Medicine Guide, MedlinePlus")
...
class RAGQueryRequest(BaseModel):
    ...
    prescription_id: Optional[str] = Field(default=None, description="Optional prescription ID to ground the answer")
